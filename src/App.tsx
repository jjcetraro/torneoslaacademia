    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          {
            process.env.REACT_APP_SHOW_REGULATION === 'true' ? <Route path='/reglamento' element={<MasterPage><RegulationPage/></MasterPage>}/> : <></>
          }
          {
            process.env.REACT_APP_SHOW_RANKING === 'true' ? <Route path='/ranking_anual' element={<MasterPage><RankingPage/></MasterPage>}/> : <></>
          }
          <Route path='/torneos' element={<MasterPage><TournamentsPage/></MasterPage>}/>
          <Route path='/thanks' element={<MessagePage message="Gracias por registrarse en el torneo!"/>}/>
          <Route path='/jugadores' element={<MasterPage><PlayersPage/></MasterPage>}/>
          <Route path='/perfil' element={<UserProfilePage/>}/>
          <Route path='/torneo/:id' element={<MasterPage><TournamentPage/></MasterPage>}/>
          <Route path='/partidos' element={<PartidosPage/>}/>
          <Route path='/cargar_resultado' element={<SetMatchResultPage/>}/>
          <Route path='/admin_dashboard' element={<AdminDashboardPage/>}/>
          <Route path='/jugadores/:id' element={<MasterPage><PlayerPage/></MasterPage>}/>
