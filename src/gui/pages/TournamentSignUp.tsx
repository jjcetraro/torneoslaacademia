...
export default function TournamentSignUp() {
  ...
  const handleClickTournamentSignUp = async (event: any) => {
    ...
    if(!player){
      ...
      player = new Player('', user.displayName, user.email, '', '', new Date(), '', '', '', {})
  ...
  const handleSelectSwitch = (event: { target: { checked: any; id: any } }) => {
